...
class Chat:
    ...
    def __call__(
        ...
        # or chain are not loaded, we load them below and save them to the chat object
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        # Textbox to specify OpenAI API key
    ...
    # - we call the Chat class, along with the default config
    # - we pass the question, along with a state
    # - and we then recieve an answer, that can be exposed in the UI
    question.submit(
        Chat(
